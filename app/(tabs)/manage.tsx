...
export default function ManageScreen() {
  ...
  const { subjects, problemSets, libraryProblems, addSubject, addProblemSet, addProblem, deleteProblemSet, deleteProblem, beginExam, importProblemSet } = useStudy();
